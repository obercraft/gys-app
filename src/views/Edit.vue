  ...
  <ion-page>
    <ion-header>
      <ion-toolbar>
        ...
        <ion-title
          >Green Yacht Solution: {{ ship.name }}
          {{ $filters.formatTime(ship.id) }}</ion-title
        >
      </ion-toolbar>
    </ion-header>
      ...
      >
        ...
        <ion-slide>
          <ion-card>
            ...
            <ion-card-content>
              <toggle-button
                v-model:target="ship.propulsion"
                ...
                <ion-item-group>
                  ...
                  >
                    ...
                    <ion-item>
                      ...
                      <ion-button @click="open('Infoblatt4.pdf')">
                        <ion-icon name="information"></ion-icon>
                      </ion-button>
                    </ion-item>
                  </ion-radio-group>
                  <ion-item>
                    ...
                    <ion-input
                      v-model="ship.systemName"
                      @ionChange="systemNameChange($event)"
                    ></ion-input>
                  </ion-item>
                </ion-item-group>
              </ion-list>
        ...
        <ion-slide>
          <ion-card>
            <ion-card-header class="cardheader">
              <ion-card-title class="cardtitle"> Batterie-Art </ion-card-title>
            </ion-card-header>
            <ion-card-content>
              <toggle-button
                v-model:target="ship.batteryType"
                :buttons="batteryTypeButtons"
              ></toggle-button>
              <ion-list>
                <ion-item-group>
                  <ion-item-divider class="divider">
                ...
                <ion-item-group>
                  <ion-item-divider class="divider">
                    <ion-label
                      >Wie weit und lange soll man fahren können?&nbsp;
                    </ion-label>
                  </ion-item-divider>
          ...
          <ion-card>
            ...
            <ion-card-content>
              <ion-list>
                ...
                <ion-radio-group
                  v-model="ship.batteryDisplay"
                  @ionChange="batteryDisplayChange($event)"
                >
                  <ion-item>
              ...
              <ion-list>
                ...
                <ion-item-divider class="divider">
                  <ion-label
                    >Muss ein Batterietrennsystem vorhanden sein?</ion-label
                  >
                </ion-item-divider>
                <ion-item>
                  <toggle-button
                    v-model:target="ship.btsExist"
                    :buttons="yesnoButtons"
                  ></toggle-button>
                </ion-item>
                ...
                <ion-item-divider class="divider">
                  <ion-label
                    >Soll über Bluetooth Daten übermittelt werden?</ion-label
                  >
                </ion-item-divider>

                <ion-item>
                  <toggle-button
                    v-model:target="ship.bluetooth"
                    :buttons="yesnoButtons"
                  ></toggle-button>
                </ion-item>
              </ion-list>
          ...
          <ion-card>
            ...
            <ion-card-content>
              <ion-list>
                <ion-item-divider class="divider">
                  <ion-label
                    >Welche Lademöglichkeiten sollen genutzt werden?</ion-label
                  >
                </ion-item-divider>
                ...
                <ion-item>
                  ...
                  <toggle-button
                    v-model:target="ship.solarPower"
                    :buttons="yesnoButtons"
                  ></toggle-button>
                </ion-item>
                ...
                <ion-item-divider class="divider">
                  <ion-label
                    >Wird ein Wechselrichter für 220V benötigt?</ion-label
                  >
                </ion-item-divider>
                <ion-item>
                  <toggle-button
                    v-model:target="ship.switchPower"
                    :buttons="yesnoButtons"
                  ></toggle-button>
                </ion-item>
                <ion-item-divider class="divider">
                  <ion-label
                    >Wie viel Leistung wird für 12V benötigt?</ion-label
                  >
                </ion-item-divider>
                ...
                <ion-item-divider class="divider">
                  <ion-label
                    >Ist die Beleuchtung auf LED umgerüstet und gibt es weitere
        ...
        <ion-slide>
          <ion-card>
            <ion-card-header class="cardheader">
              <ion-card-title class="cardtitle"> Instrumente </ion-card-title>
            </ion-card-header>
            <ion-card-content>
              <ion-list>
                <ion-item-divider class="divider">
                  <ion-label
                    >Wo sollen Instrumente installiert werden?</ion-label
                  >
                </ion-item-divider>
                ...
                <ion-item>
                  ...
                  <toggle-button
                    v-model:target="ship.instrumentSteering"
                    :buttons="yesnoButtons"
                  ></toggle-button>
                </ion-item>
                ...
                <ion-item>
                  ...
                  <toggle-button
                    v-model:target="ship.instrumentInnerRoom"
                    :buttons="yesnoButtons"
                  ></toggle-button>
                </ion-item>
                ...
                <ion-item>
                  ...
                  <toggle-button
                    v-model:target="ship.instrumentDescent"
                    :buttons="yesnoButtons"
                  ></toggle-button>
                </ion-item>
              ...
              <ion-list>
                <ion-item>
                  <ion-label class="ion-text-wrap"
                    >Winkel Gerade Motorfundament und Propellerwelle:
                  </ion-label>
                  <ion-input
                    type="number"
                    v-model="ship.engineDegree"
                  ></ion-input>
                  &deg;Grad
                </ion-item>
                ...
                <ion-item>
                  <ion-label class="ion-text-wrap"
                    >Weg Welle zum Anfang Fundament:</ion-label
                  >
                  <ion-input
                    type="number"
                    v-model="ship.waveFoundationWay"
                  ></ion-input>
                  mm
                </ion-item>
                ...
                <ion-item>
                  ...
                  <ion-input
                    type="number"
                    v-model="ship.foundationBoltHeight"
                  ></ion-input>
                  mm
                </ion-item>
                <ion-item>
                  ...
                  <ion-input
                    type="number"
                    v-model="ship.foundationBoltWidth"
                  ></ion-input>
                  mm
                </ion-item>
        ...
        <ion-slide>
          <ion-card>
            <ion-card-header class="cardheader">
              <ion-card-title class="cardtitle"> Zeitplanung </ion-card-title>
              <ion-card-title class="cardtitle">
...
export default defineComponent({
  ...
  methods: {
    ...
    save() {
      ...
      this.$router.push({
        name: "Preview",
        params: { id: this.ship.id, preview: new Date().getTime() },
      });
    },
    back() {
    ...
    open(file) {
      ...
      let fileTransfer = FileTransfer.create();
        let result = false;
      File.checkFile(File.dataDirectory, file).then((r) => {        
        result = r;
        this.fileResult.push({ result: result });
      }).finally(() => {
        ...
        if (result) {
          ...
          fileTransfer
          .download(url, File.dataDirectory + file)
          .then(() => {
          })
          .catch((error) => {
            this.fileResult.push({ error: error });
          })
          .finally(() => {
            this.fileResult.push({ done: "done" });
            DocumentViewer.viewDocument(
              File.dataDirectory + file,
              "application/pdf"
            );
